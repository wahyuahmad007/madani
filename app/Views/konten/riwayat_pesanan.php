    ...
    <div class="container mt-2">
        <div class="card " style="background-color: #EBEDEF ;">
            <ul class="nav nav-tabs ">
                <li class="nav-item">
                    <a class="nav-link " href="<?= site_url('transaksi/histori'); ?>">Pembelian</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?= site_url('pesan/histori'); ?>">Pemesanan</a>
                </li>
            </ul>
            ...
            foreach ($pesan as $value) : ?>
                <?php if ($value['id_transaksi'] == 0) { ?>
                    <p class="m-3"> Tidak ada data pesanan yang ditemukan
                    </p>
                <?php } else { ?>
                    <div class="card m-3 py-2 ">
                        <div class="card-body mt-2 ">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <a href="<?= site_url('pesan/detail'); ?>/<?= $value['id_transaksi']; ?>" class="float-end">Lihat Detail</a>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    Tanggal Pakai
                                    <br>
                                    <?= tanggal($value['tgl_kirim']); ?>
                                </div>
                                <div class="col-md-3">
                                    alamat <br>
                                  <i class="fas fa-phone">  <?= $value['no_telp']; ?></i>
                                    <?= $value['alamat']; ?>
                                </div>
